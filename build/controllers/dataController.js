...
function dataController(app) {
    ...
    /*系统信息指标*/
    var sysData = commonFunction_1.Makedata(5);
    /*系统警告*/
    var systemToke = [
        {
            id: 5,
    ...
    /*系统的详细信息*/
    var systemdatil = [
        new commonClass_1.SysDetail(5, 2017, 5, 'A1', true, 'marvin', 'xxx', '我也不知道啥原因', '没查出原因来'),
        new commonClass_1.SysDetail(2, 2016, 7, 'A1', true, 'marvin', 'xxx', '你问我我哪儿知道', '没啥意见'),
        new commonClass_1.SysDetail(1, 2015, 7, 'A1', true, 'marvin', 'xxx', '不知道', '不知道'),
    ];
    /*系统解析文件配*/
    var sysaccount = [
        new commonClass_1.SysWriteData('东北', 20, 102, false, 0.2, 0.4, 0.9, 'xxxxxxxxxxxxxxxxxxxxxx'),
        new commonClass_1.SysWriteData('华北', 32, 402, true, 0.4, 0.58, 0.8, 'xxxxxxxxxxxxxxxxxxxxxx'),
        new commonClass_1.SysWriteData('西北', 46, 982, true, 0.45, 0.47, 0.5, 'xxxxxxxxxxxxxxxxxxxxxx'),
        new commonClass_1.SysWriteData('西南', 54, 412, false, 0.89, 0.59, 0.4, 'xxxxxxxxxxxxxxxxxxxxxx'),
        new commonClass_1.SysWriteData('华南', 66, 582, true, 0.45, 0.36, 0.2, 'xxxxxxxxxxxxxxxxxxxxxx'),
        new commonClass_1.SysWriteData('华中', 10, 252, false, 0.14, 0.7, 0.1, 'xxxxxxxxxxxxxxxxxxxxxx'),
        new commonClass_1.SysWriteData('华东', 2780, 402, true, 0.258, 0.99, 0.4, 'xxxxxxxxxxxxxxxxxxxxxx'),
    ];
    /*系统的分布的具体信息的配置文件*/
    var dataSafeMap = [
        {
    ...
    var zoomData = { time: new Date(), data: commonFunction_1.makeArr() };
    /*用来发送系统夫人具体的参数的函数*/
    ...
    app.get('/api/sysmeswrite/:id', function (req, res) {
        //console.log(req.params.id);
        res.send(commonFunction_1.trueFalse());
    });
    /*用来发送系统的地图部分的数据*/
